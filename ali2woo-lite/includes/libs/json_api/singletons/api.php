...
class JSON_API
{
    ...
    public JSON_API_Query $query;
    private JSON_API_Response $response;
    private mixed $controller;

    function __construct(string $root_menu_slug)
    {
        ...
        <div class="wrap">
            ...
            <form action="admin.php?page=a2w-json-api" method="post">
                ...
                <p><strong>Note:</strong> User-friendly permalinks are not currently enabled. <a target="_blank"
                    ...
                    <?php } ?>
                <p class="submit">
                    <input type="submit" class="button-primary" value="<?php  esc_html_e('Save changes', 'ali2woo') ?>"/>
                </p>
            </form>
        </div>
        <?php
