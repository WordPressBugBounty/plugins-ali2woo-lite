<div class="a2wl-content">
    <h1><?php use AliNext_Lite\AbstractAdminPage;
        ...
        <div class="a2wl-transfer__row">
            <div class="field field_default field_inline">
                ...
                <div class="field__input-wrap">
                    <textarea class="field__input" name="hash" placeholder="<?php echo esc_html__('Paste your hash', 'ali2woo'); ?>" rows="10"><?php
                        echo esc_html__($hash);
                        ?></textarea>
                </div>
            </div>
        </div>
