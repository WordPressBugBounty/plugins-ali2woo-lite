                            ...
                            */ ?>
                            <div class="grid__col grid__col_jcenter vertical-align">
                                ...
                                <div class="input-group price-dropdown-group">
                                    <input name="default_rule[value]" sign="<?php echo $default_formula->sign ; ?>" type="text" class="input-group__input field__input form-control value" value="<?php echo $default_formula->value; ?>" <?php if (!get_setting('aliship_frontend')): ?> disabled <?php endif;?>>
